...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    from app.agent import memory_bank_service_builder, root_agent
...
app.title = "simple-gemini-agent"
app.description = "API for interacting with the Agent simple-gemini-agent"
