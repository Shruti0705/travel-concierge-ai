...
reasoning_engine adapter share instances.
"""
...
def get_memory_service():
    ...
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-02-af3d95e43a89")
    loc_env = os.environ.get("GOOGLE_CLOUD_LOCATION", "us-east1")
    location = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION") or ("us-east1" if loc_env == "global" else loc_env)
    memory_bank_id = os.environ.get("MEMORY_BANK_ID", "8090622172571107328")
